      ...
      <UserContext.Provider value={loginState}>
        <ActivityContext.Provider value={activityState}>
          ...
          >
            ...
            <Stack.Screen
              name="OrganisationCoach"
              component={OrganisationCoachScreen}
            />
            <Stack.Screen
              name="OrganisationAthlete"
              component={OrganisationAthleteScreen}
            />
            <Stack.Screen name="CreatedGroup" component={CreatedGroupScreen} />
            <Stack.Screen
              name="FriendGroupSettings"
              component={FriendGroupSettingsScreen}
            />
            <Stack.Screen
              name="FriendGroupFriend"
              component={FriendGroupFriendScreen}
            />
            <Stack.Screen
              name="OrganisationCoachSettings"
              component={OrganisationCoachSettingsScreen}
            />
            <Stack.Screen
              name="OrganisationCoachAthlete"
              component={OrganisationCoachAthleteScreen}
            />
            <Stack.Screen
              name="OrganisationAthleteFriend"
              component={OrganisationAthleteFriendScreen}
            />
